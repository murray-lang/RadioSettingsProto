...
ResultCode
MessageTraverser::updateField(pb_field_iter_t* iter, const SettingUpdateVariant &value)
{
...
ResultCode
MessageTraverser::updateSteppable(pb_field_iter_t* msg_iter, const SettingUpdateVariant& steppableValue)
{
...
ResultCode
MessageTraverser::getField(pb_field_iter_t* iter, SettingUpdateVariant& value)
{
...
MessageTraverser::StringValue
MessageTraverser::getStringValue(const SettingUpdateVariant& value)
{
